...
function WindSummaryBadge({ activity }: { activity: Activity | null }) {
  ...
  return (
    <div className="absolute top-16 left-3 md:top-3 z-10 max-w-[calc(100vw-1.5rem)] bg-[var(--color-surface-1)]/90 backdrop-blur rounded-lg border border-[var(--color-border)] px-3 py-2 text-xs space-y-1.5">
      <p className="text-[var(--color-text-muted)] font-medium uppercase tracking-wider text-[10px]">Résumé vent</p>
      {effort && (
        <div className="space-y-1 pb-1 border-b border-[var(--color-border)]">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold shrink-0" style={{ color: effortColor(effort.total) }}>
              {effort.total}/100
            </span>
          </div>
